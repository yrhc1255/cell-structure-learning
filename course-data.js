  ...
  modules: {
    shapes: {
      ...
      sections:[
        ...
        {title:'動物細胞的形態與功能',html:'<p><span class="keyword keyword-blue">神經細胞</span>具有細長突起，適合傳遞訊息；<span class="keyword keyword-red">紅血球</span>呈雙凹圓盤狀，可運送氧氣；<span class="keyword keyword-orange">肌肉細胞</span>細長且能收縮；口腔皮膜細胞扁平，具有保護功能。</p><div class="cell-type-gallery" role="list" aria-label="六種細胞的形態與功能"><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-onion" role="img" aria-label="狹長長方形且緊密排列的洋蔥表皮細胞"></span><figcaption><strong>洋蔥表皮細胞</strong><span>狹長長方形、緊密排列，形成保護層。</span></figcaption></figure><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-guard" role="img" aria-label="一對圍成氣孔的保衛細胞"></span><figcaption><strong>保衛細胞</strong><span>成對圍成氣孔，能控制氣孔開閉。</span></figcaption></figure><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-nerve" role="img" aria-label="具有許多細長突起的神經細胞"></span><figcaption><strong>神經細胞</strong><span>具有許多細長突起，適合傳遞訊息。</span></figcaption></figure><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-oral" role="img" aria-label="扁平且排列成片的口腔皮膜細胞"></span><figcaption><strong>口腔皮膜細胞</strong><span>形狀扁平，排列後具有保護作用。</span></figcaption></figure><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-blood" role="img" aria-label="呈雙凹圓盤狀的紅血球"></span><figcaption><strong>紅血球</strong><span>呈雙凹圓盤狀，主要負責運送氧氣。</span></figcaption></figure><figure class="cell-type-card" role="listitem"><span class="cell-type-image cell-type-muscle" role="img" aria-label="細長且平行排列的肌肉細胞"></span><figcaption><strong>肌肉細胞</strong><span>細長且能收縮，協助身體產生運動。</span></figcaption></figure></div>'}
      ],
      questions:[
...
window.CELL_COURSE.modules.lab.questions[5] = {
  type:'radio',
  prompt:'觀察經亞甲藍液染色的口腔皮膜細胞時，通常最容易辨認的深藍紫色構造是什麼？',
  options:[['nucleus','細胞核'],['wall','細胞壁'],['chloroplast','葉綠體']],
  correct:['nucleus'],
  explanation:'亞甲藍液可以增加影像對比，使細胞核較容易辨認。口腔皮膜細胞是動物細胞，沒有細胞壁與葉綠體。'
};
